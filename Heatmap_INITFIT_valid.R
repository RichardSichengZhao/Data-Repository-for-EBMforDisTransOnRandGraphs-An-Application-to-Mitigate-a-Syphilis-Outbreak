...
Test100_InitFIT_Valid <- read.csv(paste0(wd,"/Valid_Test100_InitFIT_combined.csv"), header=T)
#Test100_InitFIT_3QT_MASIR <-read.csv(paste0(wd,"/3QT_Test100_InitFIT_MASIR_combined.csv"), header=T)

#readmat<-Test25_Init10
readmat <- Test100_InitFIT_Valid
...
Opt
# Optimal initial condition I0=27
